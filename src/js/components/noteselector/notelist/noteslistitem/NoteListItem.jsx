      ...
      >
        {(draggableProvided, draggableSnapshot) => (
          ...
          <a
            ...
            href="#"
            className={`flex-column align-items-center list-group-item list-group-item-action px-2 ${(this.props.isSelected) && !draggableSnapshot.isDragging ? 'active' : ''} ${this.props.note.body ? '' : 'disabled font-weight-light bg-secondary text-white'}`}
            onClick={() => this.props.onSelectNote(this.props.note.id)}
          >
            <div className="d-flex w-100 align-items-center justify-content-between">
              <p id="note-list-item-title" className="text-truncate pr-2 mb-0">{this.getNoteTitle(this.props.note.body)}</p>
              <small >
